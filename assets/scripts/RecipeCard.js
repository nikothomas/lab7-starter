...
class RecipeCard extends HTMLElement {
    ...
    <p class="title"><a href="${data.titleLnk}" class="title">${data.titleTxt}</a></p>
    <p class="organization">By ${data.organization}</p>
    <div class="rating">
        Rating: ${data.rating} (${data.numRatings} reviews)
    </div>
    <p class="time">Cooking time: ${data.lengthTime}</p>
