...
function addRecipesToDocument(recipes) {
	...
	recipes.forEach(recipe => {
		...
		recipeCard.data = recipe; // Set the recipe data on the element
		mainElement.appendChild(recipeCard); // Append each element to <main>
	});
}
...
function initFormHandler() {
	...
	clearButton.addEventListener('click', function() {
		...
		mainElement.innerHTML = '';  // This will clear all the content from the main element
	});
}
